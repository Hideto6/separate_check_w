...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-blue-100 to-blue-400 p-6">
      <h1 className="text-4xl font-bold text-blue-800 text-center mb-2">ワリタビ</h1>
      <p className="text-center mb-6 text-blue-600">旅行の割り勘を、もっとスマートに。</p>
      <div className="w-80 h-48 my-5 flex items-center justify-center">
        <img src="/image/travel_icon.png" alt="travel icon" className="w-full h-full object-contain" />
      </div>
      <input
        type="text"
        placeholder="例: 東京観光"
